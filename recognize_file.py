...
def get_audio_data(file_name, tokenizer):
...
def main():
    parser = transformers.HfArgumentParser(
        (ModelArguments, DecodeArguments))
    model_args, decode_args = parser.parse_args_into_dataclasses()
    ...
    while True:
        file_name = input("\n文件名: ")
        item = get_audio_data(file_name, tokenizer)
